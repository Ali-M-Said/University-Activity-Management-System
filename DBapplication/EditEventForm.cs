...
namespace DBapplication
{
    public partial class EditEventForm : Form
    {
        ...
        private void LoadEventDetails()
        {
            ...
            comboBoxEventCat.DisplayMember = "CategoryName";
            ...
            ComboboxCreatedBy.DisplayMember = "LocName";
            ComboboxCreatedBy.ValueMember = "LocationID";
            ComboboxCreatedBy.DataSource = controller.Locations();
            ComboboxCreatedBy.SelectedValue = Convert.ToInt32(row["LocationID"]);
        }
